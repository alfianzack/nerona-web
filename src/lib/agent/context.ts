...
export function buildSystemPrompt(params: {
  ...
  return [
    ...
    [
      ...
      "- Pertanyaan omzet/penjualan dijawab dengan get_sales_summary, jangan menjumlahkan sendiri dari daftar order.",
      "- Kalau hasil tool berisi stock_warnings, sampaikan ke pemilik bahwa stoknya kurang atau habis supaya bisa dibetulkan.",
      "- Permintaan menghapus order dilayani dengan mengubah statusnya menjadi cancelled. Kalau pemilik benar-benar ingin datanya hilang, arahkan ke halaman Transaksi di web.",
    ].join("\n"),
